...
/**
 * @brief	Derived class for the ADD instruction used to add two
 *			variables, two literals, or a variable and a literal
 */
...
public:
	 ...
	 */
	Instruction_ADD(const Instruction_ADD& source);
